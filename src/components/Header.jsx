    ...
    return (
        <header className="header d-flex justify-content-between align-items-center p-3 rounded" style={styles.header}>
            ...
            <div className="d-flex align-items-center gap-3">
                ...
                <span className="d-none d-md-inline">G A P Pathum</span>
                <div className="rounded-circle d-flex align-items-center justify-content-center" 
                    style={{ ...styles.avatar, width: '30px', height: '30px' }}>GAP</div>
                
                <button className="btn btn-primary btn-sm d-none d-md-block">Logout</button>
                <button className="btn btn-primary btn-sm d-md-none"><i className="bi bi-box-arrow-right"></i></button>
            </div>
        </header>
    );
}
